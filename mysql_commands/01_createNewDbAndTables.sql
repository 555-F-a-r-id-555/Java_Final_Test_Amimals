...
CREATE TABLE IF NOT EXISTS Pets3 (
...
CREATE TABLE IF NOT EXISTS PackAnimals3 (
...
CREATE TABLE IF NOT EXISTS Commands3 (
    CommandID INT AUTO_INCREMENT PRIMARY KEY,
    CommandName VARCHAR(255)
);

-- Создание таблицы "Pets_Commands_Relationship"
CREATE TABLE IF NOT EXISTS Pets_Commands_Relationship3 (
    PetID INT,
    CommandID INT,
    FOREIGN KEY (PetID) REFERENCES Pets3(PetID),
    FOREIGN KEY (CommandID) REFERENCES Commands3(CommandID),
    PRIMARY KEY (PetID, CommandID)
);


-- Создание таблицы "PackAnimals_Commands_Relationship"
CREATE TABLE IF NOT EXISTS PackAnimals_Commands_Relationship3 (
    PackAnimalID INT,
    CommandID INT,
    FOREIGN KEY (PackAnimalID) REFERENCES PackAnimals3(PackAnimalID),
    FOREIGN KEY (CommandID) REFERENCES Commands3(CommandID),
    PRIMARY KEY (PackAnimalID, CommandID)
);

-- Добавление данных в таблицу Pets
INSERT INTO Pets3 (PetName,TypeAnimal,BirthDate) VALUES
    ('Fido', 'Dog', '2020-01-01'),
...
INSERT INTO PackAnimals3 (PackAnimalName, TypeAnimal ,BirthDate) VALUES
    ...
    ('JavaHorse','Horse','2022-01-01');
   
   -- Добавление данных в таблицу Commands
INSERT INTO Commands3 (CommandName) VALUES
    ('Sit'), -- 1
    ('Stay'), -- 2
    ('Bark'), -- 3
    ('Paw'),  -- 4
...
INSERT INTO Pets_Commands_Relationship3 (PetID, CommandID) VALUES
    (1, 1), -- Fido: Sit
    (1, 2),  -- Fido: Stay
    (1, 4),  -- Fido: Fetch
    (2, 1), -- Whiskers: Sit
...
INSERT INTO PackAnimals_Commands_Relationship3 (PackAnimalID, CommandID) VALUES
    (1, 13), -- Thunder: Trot
    (1, 14),  -- Thunder: Canter
    (1, 20),  -- Thunder: Gallop
    (2, 16), -- Sandy: Walk
